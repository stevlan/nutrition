...
export const database = (function(){
    ...
    const addItem = function(event, data){
        try{
            ...
            text.textContent = "Selected item: " + (data[Number(event.target.className)].hasOwnProperty("brandOwner") ? data[Number(event.target.className)].description + " from " + data[Number(event.target.className)].brandOwner : data[Number(event.target.className)].description);
